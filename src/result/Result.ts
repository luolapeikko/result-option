import {type IAnd, type IAndThen, type IClone, type IEquals, type IOr, type IOrElse, type IResultMatch, type IUnWrap} from '../interfaces/index.js';
import {type IOption} from '../option/Option.js';
